        ...
        {family.SubFamilies === 'Y' && (
          <div className="subgroup">
            {subfamilies
              ...
              .map((subfamily, index) => renderSubfamilyElement(subfamily, family, species, index))
            }
          </div>
        )}
      </div>
...
function renderSubfamilyElement(subfamily: Subfamily, parentFamily: Family, species: Species[], index?: number) {
      ...
      <SharedHeader
        ...
        quickLinksContent={
          <div className="links-left">
            ...
            <a className="quick-link" href="/Navigation_Sp.html" title="Consejos de navegación">Cómo navegar el sitio</a>
            <a className="quick-link" href="/About_Sp.html" title="Acerca de FotosAves">Acerca de</a>
          </div>
        }
      />
