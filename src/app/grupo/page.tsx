...
const genderMap: Record<string, { label: string; color: string }> = {
  ...
  'J': { label: '<span class="es">Juvenil</span><span class="en">Juvenile</span>', color: '#FFFFCC' },
  'I': { label: '<span class="es">Inmaduro</span><span class="en">Immature</span>', color: '#FFFFCC' },
  'MJ': { label: '<span class="es">Macho Juvenil</span><span class="en">Juvenile Male</span>', color: '#FFFFCC' },
  'FJ': { label: '<span class="es">Hembra Juvenil</span><span class="en">Juvenile Female</span>', color: '#FFFFCC' },
  'MI': { label: '<span class="es">Macho Inmaduro</span><span class="en">Immature Male</span>', color: '#FFFFCC' },
  'FI': { label: '<span class="es">Hembra Inmadura</span><span class="en">Immature Female</span>', color: '#FFFFCC' },
  'MR': { label: '<span class="es">Macho Reproductivo</span><span class="en">Breeding Male</span>', color: '#FFFFCC' },
  'FR': { label: '<span class="es">Hembra Reproductiva</span><span class="en">Breeding Female</span>', color: '#FFFFCC' },
  'MN': { label: '<span class="es">Macho No Reproductivo</span><span class="en">Non-breeding Male</span>', color: '#FFFFCC' },
  'FN': { label: '<span class="es">Hembra No Reproductiva</span><span class="en">Non-breeding Female</span>', color: '#FFFFCC' },
  'N': { label: '<span class="es">Nido</span><span class="en">Nest</span>', color: '#FFFFCC' },
};
